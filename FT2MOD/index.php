  ...
  <body>
    <div class="tri fullwidth">
      <form id="ft2mod" name="ft2mod">
        <div class="tri">
          <div class="ang le-full"><h1>FT<span>2</span>MOD</h1></div>
          <div class="ang le-full">
            <div class="ft2mod-c-options-panel">
              <div class="tri">
                ...
                <div class="ang le-full md-third">
                  <label for="ft2mod-a-effects-are-priority">Prioritise effects over volume: <input type="checkbox" name="ft2mod-a-effects-are-priority" id="ft2mod-a-effects-are-priority" /></label>
          ...
          <div class="ang le-full lg-half">
            <strong class="title">FamiTracker Export</strong><br>
            <textarea name="FT_2" placeholder="PASTE FAMITRACKER TEXT HERE"></textarea>
          </div>
          <div class="ang le-full lg-half">
            <strong>MOD Output</strong><br>
